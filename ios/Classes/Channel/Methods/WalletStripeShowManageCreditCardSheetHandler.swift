//
//  WalletStripeShowManageCreditCardSheetHandler.swift
//
//
...
class WalletStripeShowManageCreditCardSheetHandler {
    ...
    func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        Task {
            do {
                ...
                try await stripe.showManageCreditCardsSheet(stripeKeys: keys, buttonLabel: buttonLabel) { paymentResult in
